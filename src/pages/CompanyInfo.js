      ...
      <div className="compInfo col-7 col">
        ...
        <div className="goalDiv">
          <div className="missionDiv">
            <h3>My Mission</h3>
            <p>
              To support and guide the individual and their loved ones during
              the end of life process to transform their experience into one of
              deep meaning and peaceful transition. To provide assistance in
          ...
          <div className="visionDiv">
            <h3>My Vision</h3>
            <p>
              To transform the natural process of dying for all individuals into
              a celebration of life and a gift of legacy to take root and grow
              in those left behind.
            </p>
          </div>
        </div>
      </div>
      <div className="compInfoQuote  col-3 col">
        "Return control of your final journey back to you and your loved ones to
        make it the beautiful, memorable transition it was meant to be."
      </div>
    </div>
  );
}
